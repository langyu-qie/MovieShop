...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210930060722_CreateFavoriteTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Models.CastModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Models.GenreModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Models.MovieDetailsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Models.TrailerModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieCast", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Models.MovieDetailsModel", "MovieDetails")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplicationCore.Models.CastModel", b =>
                {
                    b.HasOne("ApplicationCore.Models.MovieDetailsModel", null)
                        .WithMany("Casts")
