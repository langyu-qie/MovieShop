...
namespace Infrastructure.Services
{
    public class AdminService : IAdminService
    {
        ...
        public AdminService(IMovieRepository movieRepository, IPurchaseRepository purchaseRepository, IReportsRepository reportsRepository)
        {
        ...
        public async Task<MovieDetailsModel> CreateMovie(MovieCreateRequest movieCreateRequest)
        {
        ...
        public async Task<MovieDetailsModel> UpdateMovie(MovieCreateRequest movieCreateRequest)
        {
            //var movie = _mapper.Map<Movie>(movieCreateRequest);
